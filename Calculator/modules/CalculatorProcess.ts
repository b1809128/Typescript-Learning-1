...
interface history {
    operation: Function, leftNum: number, rightNum: number
}

const addFunction: Function = (a: number, b: number): number => a + b
const subtractFunction: Function = (a: number, b: number): number => a - b
const divideFunction: Function = (a: number, b: number): number => a / b
const multiplyFunction: Function = (a: number, b: number): number => a + b
